...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001319cf27000000007b2f4914(
...
class phpbbtemplatetwiglexer_000000001319cf27000000007b2f4914 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c23775b5fbb5999980915 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c23775b5fbf2547210533 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c23775b5fb2b129038237 = array(
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, 'set_environment', array('env' => $env), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;

        return $this->valueHolder5c23775b5fbb5999980915->set_environment($env);
    }
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;

        return $this->valueHolder5c23775b5fbb5999980915->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;

        return $this->valueHolder5c23775b5fbb5999980915->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c23775b5fbf2547210533 = $initializer;
    }
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, '__get', array('name' => $name), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;

        if (isset(self::$publicProperties5c23775b5fb2b129038237[$name])) {
            return $this->valueHolder5c23775b5fbb5999980915->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c23775b5fbb5999980915;
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, '__isset', array('name' => $name), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, '__unset', array('name' => $name), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;
    ...
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, '__clone', array(), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;

        $this->valueHolder5c23775b5fbb5999980915 = clone $this->valueHolder5c23775b5fbb5999980915;
    }

    public function __sleep()
    {
        $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, '__sleep', array(), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;

        return array('valueHolder5c23775b5fbb5999980915');
    }
    ...
    {
        return $this->initializer5c23775b5fbf2547210533;
    }
    ...
    {
        return $this->initializer5c23775b5fbf2547210533 && ($this->initializer5c23775b5fbf2547210533->__invoke($valueHolder5c23775b5fbb5999980915, $this, 'initializeProxy', array(), $this->initializer5c23775b5fbf2547210533) || 1) && $this->valueHolder5c23775b5fbb5999980915 = $valueHolder5c23775b5fbb5999980915;
    }
    ...
    {
        return null !== $this->valueHolder5c23775b5fbb5999980915;
    }
    ...
    {
        return $this->valueHolder5c23775b5fbb5999980915;
    }

...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000042b08cf30000000026c65662(
...
class phpbbtemplatetwiglexer_0000000042b08cf30000000026c65662 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c2377081dea8478879462 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c2377081dee5518883233 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c2377081de1b720337030 = array(
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, 'set_environment', array('env' => $env), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;

        return $this->valueHolder5c2377081dea8478879462->set_environment($env);
    }
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;

        return $this->valueHolder5c2377081dea8478879462->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;

        return $this->valueHolder5c2377081dea8478879462->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c2377081dee5518883233 = $initializer;
    }
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, '__get', array('name' => $name), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;

        if (isset(self::$publicProperties5c2377081de1b720337030[$name])) {
            return $this->valueHolder5c2377081dea8478879462->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c2377081dea8478879462;
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, '__isset', array('name' => $name), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, '__unset', array('name' => $name), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;
    ...
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, '__clone', array(), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;

        $this->valueHolder5c2377081dea8478879462 = clone $this->valueHolder5c2377081dea8478879462;
    }

    public function __sleep()
    {
        $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, '__sleep', array(), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;

        return array('valueHolder5c2377081dea8478879462');
    }
    ...
    {
        return $this->initializer5c2377081dee5518883233;
    }
    ...
    {
        return $this->initializer5c2377081dee5518883233 && ($this->initializer5c2377081dee5518883233->__invoke($valueHolder5c2377081dea8478879462, $this, 'initializeProxy', array(), $this->initializer5c2377081dee5518883233) || 1) && $this->valueHolder5c2377081dea8478879462 = $valueHolder5c2377081dea8478879462;
    }
    ...
    {
        return null !== $this->valueHolder5c2377081dea8478879462;
    }
    ...
    {
        return $this->valueHolder5c2377081dea8478879462;
    }

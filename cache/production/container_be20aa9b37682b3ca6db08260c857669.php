...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getAttachment_DeleteService()
    {
        ...
        return new \phpbb\attachment\delete($this->get('config'), $a, $this->get('dispatcher'), $this->get('filesystem'), new \phpbb\attachment\resync($a), 'C:/wamp64/www/forum/');
    }
    ...
    protected function getAttachment_ManagerService()
    {
        ...
        return new \phpbb\attachment\manager(new \phpbb\attachment\delete($b, $a, $c, $this->get('filesystem'), new \phpbb\attachment\resync($a), 'C:/wamp64/www/forum/'), new \phpbb\attachment\resync($a), new \phpbb\attachment\upload($this->get('auth'), $this->get('cache'), $b, $this->get('files.upload'), $this->get('language'), $this->get('mimetype.guesser'), $c, $this->get('plupload'), $this->get('user'), 'C:/wamp64/www/forum/'));
    }
    ...
    protected function getAttachment_UploadService()
    {
        ...
        return new \phpbb\attachment\upload($this->get('auth'), $this->get('cache'), $this->get('config'), new \phpbb\files\upload($this->get('filesystem'), $this->get('files.factory'), $a, $this->get('php_ini'), $this->get('request')), $a, $this->get('mimetype.guesser'), $this->get('dispatcher'), $this->get('plupload'), $this->get('user'), 'C:/wamp64/www/forum/');
    }
    ...
    {
        return $this->services['auth.provider.apache'] = new \phpbb\auth\provider\apache($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['auth.provider.db'] = new \phpbb\auth\provider\db($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), $this, 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        $this->services['avatar.driver.gravatar'] = $instance = new \phpbb\avatar\driver\gravatar($this->get('config'), $this->get('upload_imagesize'), 'C:/wamp64/www/forum/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.local'] = $instance = new \phpbb\avatar\driver\local($this->get('config'), $this->get('upload_imagesize'), 'C:/wamp64/www/forum/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.remote'] = $instance = new \phpbb\avatar\driver\remote($this->get('config'), $this->get('upload_imagesize'), 'C:/wamp64/www/forum/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), 'C:/wamp64/www/forum/', 'php', $this->get('filesystem'), $this->get('path_helper'), $this->get('dispatcher'), $this->get('files.factory'), $this->get('cache.driver'));
    ...
    {
        return $this->services['cache'] = new \phpbb\cache\service($this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        $this->services['class_loader'] = $instance = new \phpbb\class_loader('phpbb\\', 'C:/wamp64/www/forum/includes/', 'php');
    ...
    {
        $this->services['class_loader.ext'] = $instance = new \phpbb\class_loader('\\', 'C:/wamp64/www/forum/ext/', 'php');
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate($this->get('user'), $this->get('language'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), $this->get('filesystem'), 'C:/wamp64/www/forum/');
    }
    ...
    {
        return $this->services['console.command.db.revert'] = new \phpbb\console\command\db\revert($this->get('user'), $this->get('language'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), $this->get('filesystem'), 'C:/wamp64/www/forum/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.delete'] = new \phpbb\console\command\thumbnail\delete($this->get('user'), $this->get('dbal.conn'), 'C:/wamp64/www/forum/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.generate'] = new \phpbb\console\command\thumbnail\generate($this->get('user'), $this->get('dbal.conn'), $this->get('cache'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.activate'] = new \phpbb\console\command\user\activate($this->get('user'), $this->get('dbal.conn'), $this->get('config'), $this->get('language'), $this->get('log'), $this->get('notification_manager'), $this->get('user_loader'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.add'] = new \phpbb\console\command\user\add($this->get('user'), $this->get('dbal.conn'), $this->get('config'), $this->get('language'), $this->get('passwords.manager'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.delete'] = new \phpbb\console\command\user\delete($this->get('user'), $this->get('dbal.conn'), $this->get('language'), $this->get('log'), $this->get('user_loader'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), 'C:/wamp64/www/forum/', 'php', 'phpbb_forums', 'phpbb_posts', 'phpbb_topics', 'phpbb_users');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this, 'C:/wamp64/www/forum/', $this->get('template'));
    }
    ...
    {
        return $this->services['cron.manager'] = new \phpbb\cron\manager($this->get('cron.task_collection'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        $this->services['cron.task.core.prune_all_forums'] = $instance = new \phpbb\cron\task\core\prune_all_forums('C:/wamp64/www/forum/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_forum'] = $instance = new \phpbb\cron\task\core\prune_forum('C:/wamp64/www/forum/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('C:/wamp64/www/forum/', 'php', $this->get('config'), $this->get('dbal.conn'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('C:/wamp64/www/forum/', 'php', $this->get('config'), 'C:/wamp64/www/forum/cache/production/');
    ...
    {
        $this->services['cron.task.core.tidy_database'] = $instance = new \phpbb\cron\task\core\tidy_database('C:/wamp64/www/forum/', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('C:/wamp64/www/forum/', $this->get('config'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('C:/wamp64/www/forum/', 'php', $this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('dispatcher'));
    ...
    {
        $this->services['cron.task.core.tidy_warnings'] = $instance = new \phpbb\cron\task\core\tidy_warnings('C:/wamp64/www/forum/', 'php', $this->get('config'));
    ...
    {
        return new \phpbb\db\extractor\mssql_extractor('C:/wamp64/www/forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\mysql_extractor('C:/wamp64/www/forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\oracle_extractor('C:/wamp64/www/forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\postgres_extractor('C:/wamp64/www/forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\sqlite3_extractor('C:/wamp64/www/forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbb_ext', 'C:/wamp64/www/forum/', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['feed.quote_helper'] = new \phpbb\feed\quote_helper($this->get('user'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['file_locator'] = new \phpbb\routing\file_locator($this->get('filesystem'), 'C:/wamp64/www/forum/');
    }
    ...
    {
        return new \phpbb\files\filespec($this->get('filesystem'), $this->get('language'), $this->get('php_ini'), $this->get('upload_imagesize'), 'C:/wamp64/www/forum/', $this->get('mimetype.guesser'), $this->get('plupload'));
    }
    ...
    {
        return new \phpbb\files\types\remote($this->get('config'), $this->get('files.factory'), $this->get('language'), $this->get('php_ini'), $this->get('request'), 'C:/wamp64/www/forum/');
    }
    ...
    {
        return $this->services['hook_finder'] = new \phpbb\hook\finder('C:/wamp64/www/forum/', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['language.helper.language_file'] = new \phpbb\language\language_file_helper('C:/wamp64/www/forum/');
    }
    ...
    {
        $this->services['language.loader'] = $instance = new \phpbb\language\language_file_loader('C:/wamp64/www/forum/', 'php');
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), 'C:/wamp64/www/forum/', 'adm/', 'php', 'phpbb_log');
    }
    ...
    {
        return $this->services['message.form.admin'] = new \phpbb\message\admin_form($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('dbal.conn'), $this->get('user'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['message.form.topic'] = new \phpbb\message\topic_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['message.form.user'] = new \phpbb\message\user_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbb_migrations', 'C:/wamp64/www/forum/', 'php', 'phpbb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), 'C:/wamp64/www/forum/', 'php', 'phpbb_modules');
    }
    ...
    {
        return $this->services['migrator.tool.permission'] = new \phpbb\db\migration\tool\permission($this->get('dbal.conn'), $this->get('cache'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbb_modules', 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email($this->get('user_loader'), $this->get('user'), $this->get('config'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\jabber($this->get('user_loader'), $this->get('user'), $this->get('config'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), 'C:/wamp64/www/forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        return $this->services['passwords.driver.md5_phpbb2'] = new \phpbb\passwords\driver\md5_phpbb2($this->get('request'), $this->get('passwords.driver.salted_md5'), $this->get('passwords.driver_helper'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), $this->get('request'), 'C:/wamp64/www/forum/', 'php', 'adm/');
    }
    ...
    {
        return $this->services['phpbb.help.controller.bbcode'] = new \phpbb\help\controller\bbcode($this->get('controller.helper'), $this->get('phpbb.help.manager'), $this->get('template'), $this->get('language'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['phpbb.help.controller.faq'] = new \phpbb\help\controller\faq($this->get('controller.helper'), $this->get('phpbb.help.manager'), $this->get('template'), $this->get('language'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['phpbb.report.controller'] = new \phpbb\report\controller\report($this->get('config'), $this->get('user'), $this->get('template'), $this->get('controller.helper'), $this->get('request'), $this->get('captcha.factory'), $this->get('phpbb.report.handler_factory'), $this->get('phpbb.report.report_reason_list_provider'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['phpbb.viglink.acp_listener'] = new \phpbb\viglink\event\acp_listener($this->get('config'), $this->get('language'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('phpbb.viglink.helper'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('C:/wamp64/www/forum/', $this->get('config'), $this->get('request'), $this->get('user'), $this->get('php_ini'), $this->get('mimetype.guesser'));
    }
    ...
    {
        return $this->services['router'] = new \phpbb\routing\router($this, $this->get('routing.chained_resources_locator'), $this->get('routing.delegated_loader'), 'php', 'C:/wamp64/www/forum/cache/production/');
    }
    ...
    {
        return $this->services['routing.helper'] = new \phpbb\routing\helper($this->get('config'), $this->get('router'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    {
        return $this->services['routing.resources_locator.default'] = new \phpbb\routing\resources_locator\default_resources_locator('C:/wamp64/www/forum/', 'production', $this->get('ext.manager'));
    }
    ...
    {
        return $this->services['template'] = new \phpbb\template\twig\twig($this->get('path_helper'), $this->get('config'), $this->get('template_context'), $this->get('template.twig.environment'), 'C:/wamp64/www/forum/cache/production/twig/', $this->get('user'), $this->get('template.twig.extensions.collection'), $this->get('ext.manager'));
    }
    ...
    {
        $this->services['template.twig.environment'] = $instance = new \phpbb\template\twig\environment($this->get('config'), $this->get('filesystem'), $this->get('path_helper'), 'C:/wamp64/www/forum/cache/production/twig/', $this->get('ext.manager'), $this->get('template.twig.loader'), $this->get('dispatcher'), array());
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000dca719d000000004526f39d(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbb_bbcodes', 'phpbb_smilies', 'phpbb_styles', 'phpbb_words', 'C:/wamp64/www/forum/styles/');
    }
    ...
    {
        return $this->services['text_formatter.s9e.quote_helper'] = new \phpbb\textformatter\s9e\quote_helper($this->get('user'), 'C:/wamp64/www/forum/', 'php');
    }
    ...
    protected function getTextFormatter_S9e_RendererService()
    {
        ...
        $this->services['text_formatter.s9e.renderer'] = $instance = new \phpbb\textformatter\s9e\renderer($this->get('cache.driver'), 'C:/wamp64/www/forum/cache/production/', '_text_formatter_renderer', $this->get('text_formatter.s9e.factory'), $this->get('dispatcher'));
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), 'C:/wamp64/www/forum/', 'php', 'phpbb_users');
    }
    ...
    {
        return array(
            'core.root_path' => 'C:/wamp64/www/forum/',
            'core.php_ext' => 'php',
            'core.environment' => 'production',
            'core.debug' => false,
            'core.cache_dir' => 'C:/wamp64/www/forum/cache/production/',
            'passwords.driver.bcrypt_cost' => 10,
            'text_formatter.cache.dir' => 'C:/wamp64/www/forum/cache/production/',
            'text_formatter.cache.parser.key' => '_text_formatter_parser',
            'text_formatter.cache.renderer.key' => '_text_formatter_renderer',
            'core.template.cache_path' => 'C:/wamp64/www/forum/cache/production/twig/',
...
class phpbbtemplatetwiglexer_000000000dca719d000000004526f39d extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c2462876c696576390761 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c2462876c6d2851998187 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c2462876c608579586125 = array(
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, 'set_environment', array('env' => $env), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;

        return $this->valueHolder5c2462876c696576390761->set_environment($env);
    }
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;

        return $this->valueHolder5c2462876c696576390761->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;

        return $this->valueHolder5c2462876c696576390761->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c2462876c6d2851998187 = $initializer;
    }
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, '__get', array('name' => $name), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;

        if (isset(self::$publicProperties5c2462876c608579586125[$name])) {
            return $this->valueHolder5c2462876c696576390761->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c2462876c696576390761;
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, '__isset', array('name' => $name), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, '__unset', array('name' => $name), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;
    ...
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, '__clone', array(), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;

        $this->valueHolder5c2462876c696576390761 = clone $this->valueHolder5c2462876c696576390761;
    }

    public function __sleep()
    {
        $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, '__sleep', array(), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;

        return array('valueHolder5c2462876c696576390761');
    }
    ...
    {
        return $this->initializer5c2462876c6d2851998187;
    }
    ...
    {
        return $this->initializer5c2462876c6d2851998187 && ($this->initializer5c2462876c6d2851998187->__invoke($valueHolder5c2462876c696576390761, $this, 'initializeProxy', array(), $this->initializer5c2462876c6d2851998187) || 1) && $this->valueHolder5c2462876c696576390761 = $valueHolder5c2462876c696576390761;
    }
    ...
    {
        return null !== $this->valueHolder5c2462876c696576390761;
    }
    ...
    {
        return $this->valueHolder5c2462876c696576390761;
    }

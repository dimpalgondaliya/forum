...
/* overall_footer.html */
class __TwigTemplate_38a4dfcbdf7481217df7684a631467ecd513b633a2f33191734976262ba0e1c9 extends Twig_Template
{
...
\t<div class=\"copyright\">
\t\t<!-- <p class=\"footer-row\">
\t\t\t<span class=\"footer-copyright\">Flat Styllllle by <a href=\"http://iansvivarium.com\">Ian Bradley</a></span>
\t\t</p>
        <p class=\"footer-row\">
...
";
        ...
        $this->getEnvironment()->get_assets_bag()->add_script($asset);        // line 65
        $asset_file = "ajax.js";
        $asset = new \phpbb\template\asset($asset_file, $this->getEnvironment()->get_path_helper(), $this->getEnvironment()->get_filesystem());
        if (substr($asset_file, 0, 2) !== './' && $asset->is_relative()) {
            $asset_path = $asset->get_path();            $local_file = $this->getEnvironment()->get_phpbb_root_path() . $asset_path;
        ...
        $this->getEnvironment()->get_assets_bag()->add_script($asset);        // line 66
        if (($context["S_ALLOW_CDN"] ?? null)) {
            // line 67
...
";
    ...
    {
        return array (  289 => 115,  288 => 114,  283 => 112,  269 => 111,  266 => 110,  261 => 109,  258 => 108,  247 => 100,  243 => 99,  239 => 98,  235 => 97,  213 => 81,  211 => 80,  208 => 79,  198 => 72,  191 => 67,  189 => 66,  178 => 65,  167 => 64,  160 => 63,  152 => 62,  148 => 61,  144 => 59,  140 => 58,  117 => 40,  102 => 36,  93 => 32,  87 => 29,  80 => 25,  74 => 24,  68 => 21,  62 => 20,  56 => 17,  50 => 14,  42 => 8,  30 => 7,  26 => 5,  25 => 4,  21 => 2,  19 => 1,);
    }
